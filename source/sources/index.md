...
- [Chat2DB: 智能且多功能的SQL客户端和报表工具，适用于各种数据库](https://github.com/chat2db/Chat2DB/blob/main/README_CN.md)
...
- [AI辅助正则表达式：AI-Powered Regular Expression Solver](https://regex.ai/)
